...
public class LentaPage extends BaseUserPage {
    ...
    public LentaPage(PageParameters pp) {
        ...
        ComponentFactory f = markupId -> new GroupsListPanel(markupId, state.activeCategory);
        ...
        add(new GroupsListPanel("groups", state.activeCategory));
        add(new CreateZametkaButtonPanel("create_panel", state.activeCategory));
        add(lenta);

        lenta.add(new GroupHeader("group_name", state.activeCategory));
    ...
    private class LentaProvider extends AbstractListProvider<ZametkaId> {
        ...
        public List<ZametkaId> getList() {
            ...
            GroupId activeCategory = state.activeCategory.getObject();
