...
public class Scripts {
    ...
    public static final JavaScriptUrlReferenceHeaderItem AUTOLINKER_JS = forUrl("https://cdnjs.cloudflare.com/ajax/libs/autolinker/1.4.1/Autolinker.js", "autolinker.js");
